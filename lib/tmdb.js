...
function getAuthConfig() {
  // Assignment requirement: use v3 API key auth via query param `api_key`.
  // Set this in your environment (recommended via `.env`):
  // EXPO_PUBLIC_TMDB_API_KEY=YOUR_KEY_HERE
  const apiKey = process.env.EXPO_PUBLIC_TMDB_API_KEY;

  // Optional: TMDB v4 "API Read Access Token" (Bearer). Not required for the assignment,
  // but supported if you want to use it.
